...
class NewprojectApp:
    ...
    def frame3build(self, program):
        ...
        images.configure()
        image1 = Image.open(path + "/TB-RedOS/images/" +description.dict.get(program).get("images")[0])
        ...
        image2 = Image.open(path + "/TB-RedOS/images/" +description.dict.get(program).get("images")[1])
        ...
        image3 = Image.open(path + "/TB-RedOS/images/" +description.dict.get(program).get("images")[2])
